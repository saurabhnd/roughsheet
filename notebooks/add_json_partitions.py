...
# MAGIC %sql
# MAGIC show create table prd_json.events;

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE  TABLE `dev_json`.`events` (   `val` STRING,   `event_type` STRING,   `v` STRING,   `ds` STRING,   `hr` STRING) USING text PARTITIONED BY (event_type, v, ds, hr) LOCATION 's3://dev-event-json.datalake.nextdoor.com/' TBLPROPERTIES (   'transient_lastDdlTime' = '1463025023')

# COMMAND ----------

# data_lake__events_hourly, all.add_json_partitions, 20220505T180000, prd
...
if __name__ == '__main__':
    ...
    #rename_col_and_write(df, 's3://prd-spark-logging-orc-datalake-analytics-nextdoor-com/data_lake__events_hourly/all.add_json_partitions/20220505180000/3')
